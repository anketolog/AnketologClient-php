...
/**
 * CampaignTransferInfoBody Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     AnketologClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CampaignTransferInfoBody implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'CampaignTransferInfoBody';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['transfer_id'] === null) {
            $invalid_properties[] = "'transfer_id' can't be null";
        }
    ...
    /**
     * Sets transfer_id
     * @param int $transfer_id ID перевода
     * @return $this
     */
