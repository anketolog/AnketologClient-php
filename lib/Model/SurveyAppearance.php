...
class SurveyAppearance implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'credentials' => '\Swagger\Client\Model\SurveyCredential[]'
    );
    ...
    /**
     * Sets startpage_text
     * @param string $startpage_text Текст на странцие приветствия
     * @return $this
     */
    ...
    /**
     * Sets finish_type
     * @param string $finish_type Тип завершени анкеты
     * @return $this
     */
    ...
    /**
     * Sets custom_css
     * @param string $custom_css Пользователькая css
     * @return $this
     */
    ...
    /**
     * Gets credentials
     * @return \Swagger\Client\Model\SurveyCredential[]
     */
    ...
    /**
     * Sets credentials
     * @param \Swagger\Client\Model\SurveyCredential[] $credentials
     * @return $this
     */
