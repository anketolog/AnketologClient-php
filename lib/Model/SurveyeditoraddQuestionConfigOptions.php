...
/**
 * SurveyeditoraddQuestionConfigOptions Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     AnketologClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyeditoraddQuestionConfigOptions implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'surveyeditoraddQuestion_config_options';
    ...
    /**
     * Sets image_id
     * @param int $image_id ID изображения  Для вопросов:  * `select` * `multiselect`
     * @return $this
     */
    ...
    /**
     * Sets values
     * @param \AnketologClient\Model\SurveyeditoraddOptionConfigValues[] $values
     * @return $this
     */
