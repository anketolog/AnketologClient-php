...
/**
 * SurveyStruct Class Doc Comment
 *
 * @category    Class */
 // @description Структура опроса
/** 
 * @package     Swagger\Client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyStruct implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SurveyStruct';
    ...
    protected static $swaggerTypes = array(
        'pages' => '\Swagger\Client\Model\SurveyPage[]',
        'pages_count' => 'int'
    );
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pages_count'] === null) {
            $invalid_properties[] = "'pages_count' can't be null";
        }
    ...
    /**
     * Gets pages
     * @return \Swagger\Client\Model\SurveyPage[]
     */
    ...
    /**
     * Sets pages
     * @param \Swagger\Client\Model\SurveyPage[] $pages
     * @return $this
     */
