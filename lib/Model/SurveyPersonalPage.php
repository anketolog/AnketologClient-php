...
/**
 * SurveyPersonalPage Class Doc Comment
 *
 * @category    Class */
 // @description Персональная страница у опроса
/** 
 * @package     AnketologClient
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyPersonalPage implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SurveyPersonalPage';
    ...
    /**
     * Sets id
     * @param int $id ID персональной страницы
     * @return $this
     */
    ...
    /**
     * Sets position
     * @param int $position Позиция анкеты на персональной странице
     * @return $this
     */
