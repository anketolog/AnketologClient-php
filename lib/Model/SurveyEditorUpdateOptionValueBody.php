<?php
/**
 * SurveyEditorUpdateOptionValueBody
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * SurveyEditorUpdateOptionValueBody Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     AnketologClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyEditorUpdateOptionValueBody implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SurveyEditorUpdateOptionValueBody';
    ...
    protected static $swaggerTypes = array(
        'survey_id' => 'int',
        'option_value_id' => 'int',
        'config' => '\AnketologClient\Model\SurveyeditoraddOptionConfigValues'
    );
     ...
     * @param int $option_value_id ID варианта
     * @return $this
     */
    ...
    /**
     * Sets config
     * @param \AnketologClient\Model\SurveyeditoraddOptionConfigValues $config
     * @return $this
     */
