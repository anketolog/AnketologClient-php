...
class CampaignTargetingAviaperelety implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['sovershenie_pereletov'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'sovershenie_pereletov', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2");
        if (!in_array($this->container['cel_aviapereletov'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'cel_aviapereletov', must be one of #{allowed_values}.";
        }
