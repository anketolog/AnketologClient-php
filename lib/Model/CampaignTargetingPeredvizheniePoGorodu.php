...
class CampaignTargetingPeredvizheniePoGorodu implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['ispolzovanie_transporta'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'ispolzovanie_transporta', must be one of #{allowed_values}.";
        }
