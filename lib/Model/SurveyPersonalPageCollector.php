...
/**
 * SurveyPersonalPageCollector Class Doc Comment
 *
 * @category    Class */
 // @description Способ распространения опроса \&quot;персональная страница\&quot;
/** 
 * @package     AnketologClient
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyPersonalPageCollector extends SurveyCollector implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SurveyPersonalPageCollector';
    ...
    protected static $attributeMap = array(
        ...
        'personalpage_url' => 'personalpage_url'
    );
    ...
    protected static $setters = array(
        ...
        'personalpage_url' => 'setPersonalpageUrl'
    );
    ...
    protected static $getters = array(
        ...
        'personalpage_url' => 'getPersonalpageUrl'
    );
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['personalpage_url'] = isset($data['personalpage_url']) ? $data['personalpage_url'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['personalpage_url'] === null) {
            $invalid_properties[] = "'personalpage_url' can't be null";
        }
    ...
    /**
     * Gets personalpage_url
     * @return string
     */
    public function getPersonalpageUrl()
    {
        return $this->container['personalpage_url'];
    }

    /**
     * Sets personalpage_url
     * @param string $personalpage_url URL персональной страницы
     * @return $this
     */
    public function setPersonalpageUrl($personalpage_url)
    {
        $this->container['personalpage_url'] = $personalpage_url;
