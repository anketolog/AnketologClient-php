<?php
/**
 * SurveyReportAggregateMatrix3DAnswerOptions
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * SurveyReportAggregateMatrix3DAnswerOptions Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     AnketologClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyReportAggregateMatrix3DAnswerOptions implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SurveyReportAggregateMatrix3DAnswer_options';
    ...
    protected static $swaggerTypes = array(
        'option_id' => 'int',
        'option_values' => '\AnketologClient\Model\SurveyReportAggregateMatrix3DAnswerOptionValues[]'
    );
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['option_values'] === null) {
            $invalid_properties[] = "'option_values' can't be null";
        }
    ...
    /**
     * Gets option_values
     * @return \AnketologClient\Model\SurveyReportAggregateMatrix3DAnswerOptionValues[]
     */
    ...
    /**
     * Sets option_values
     * @param \AnketologClient\Model\SurveyReportAggregateMatrix3DAnswerOptionValues[] $option_values
     * @return $this
     */
