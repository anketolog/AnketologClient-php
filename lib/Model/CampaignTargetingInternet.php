...
class CampaignTargetingInternet implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['socialnye_seti'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'socialnye_seti', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1");
        if (!in_array($this->container['sovershenie_pokupok_cherez_internet'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'sovershenie_pokupok_cherez_internet', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2", "option_3");
        if (!in_array($this->container['vidy_tovarov_zakazyvaemyh_cherez_internet'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'vidy_tovarov_zakazyvaemyh_cherez_internet', must be one of #{allowed_values}.";
        }
