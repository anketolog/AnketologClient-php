...
/**
 * SurveyReportFilterSource Class Doc Comment
 *
 * @category    Class */
...
class SurveyReportFilterSource extends SurveyReportFilter implements ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SurveyReportFilterSource';
    ...
    /**
     * Sets sources
     * @param string[] $sources Источник ответа
     * @return $this
     */
