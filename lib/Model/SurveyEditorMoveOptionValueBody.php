...
/**
 * SurveyEditorMoveOptionValueBody Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     AnketologClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyEditorMoveOptionValueBody implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SurveyEditorMoveOptionValueBody';
     ...
     * @param int $option_value_id ID варианта ответа в колонке
     * @return $this
     */
