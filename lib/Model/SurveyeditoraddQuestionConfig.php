...
class SurveyeditoraddQuestionConfig implements ArrayAccess
{
    ...
    /**
     * Sets comment
     * @param string $comment Комментарий к вопросу (HTML)  Для вопросов:  * `free` * `freelist` * `freematrix` * `select` * `multiselect` * `dropdown` * `matrix` * `matrix3d` * `name` * `email` * `phone` * `file` * `date` * `scale` * `order` * `ratingscale`
     * @return $this
     */
    ...
    /**
     * Sets has_comment
     * @param bool $has_comment Отображать комментарий к вопросу  Для вопросов:  * `free` * `freelist` * `freematrix` * `select` * `multiselect` * `dropdown` * `matrix` * `matrix3d` * `name` * `email` * `phone` * `file` * `date` * `scale` * `order` * `ratingscale`
     * @return $this
     */
    ...
    /**
     * Sets is_required
     * @param bool $is_required Вопрос обазательный  Для вопросов:  * `free` * `freelist` * `freematrix` * `select` * `multiselect` * `dropdown` * `matrix` * `matrix3d` * `name` * `email` * `phone` * `file` * `date` * `scale` * `order` * `ratingscale`
     * @return $this
     */
    ...
    /**
     * Sets is_enable
     * @param bool $is_enable Вопрос виден респонденту  Для вопросов:  * `html` * `free` * `freelist` * `freematrix` * `select` * `multiselect` * `dropdown` * `matrix` * `matrix3d` * `name` * `email` * `phone` * `file` * `date` * `scale` * `order` * `ratingscale`
     * @return $this
     */
     ...
     * @param bool $has_unable_answer Вариант \"затрудняюсь ответить\"  Для вопросов:  * `free` * `freelist` * `freematrix` * `select` * `multiselect` * `dropdown` * `matrix` * `matrix3d` * `name` * `email` * `phone` * `file` * `date` * `scale` * `order` * `ratingscale`
     * @return $this
     */
    ...
    /**
     * Sets options_sort
     * @param string $options_sort Сортировка вариантов  * `default` - по умолчанию * `alphabet` - в алфавитном порядке * `random` - в случайном порядке  Для вопросов:  * `freelist` * `freematrix` * `select` * `multiselect` * `dropdown` * `matrix` * `matrix3d` * `order` * `ratingscale`
     * @return $this
     */
    ...
    /**
     * Sets is_limited
     * @param bool $is_limited Включить ограничение количества выбранных вариантов  Для вопросов:  * `multiselect` * `free` * `freelist` * `freematrix`
     * @return $this
     */
