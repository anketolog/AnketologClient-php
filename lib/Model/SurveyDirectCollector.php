...
/**
 * SurveyDirectCollector Class Doc Comment
 *
 * @category    Class */
 // @description Способ распространения опроса \&quot;прямая ссылка\&quot;
/** 
 * @package     AnketologClient
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyDirectCollector extends SurveyCollector implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SurveyDirectCollector';
    ...
    /**
     * Sets direct_url
     * @param string $direct_url URL прямой ссылки
     * @return $this
     */
