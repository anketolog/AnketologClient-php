...
/**
 * SurveyReportDetailFreelistAnswerOptions Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     AnketologClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyReportDetailFreelistAnswerOptions implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SurveyReportDetailFreelistAnswer_options';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['answer_text'] === null) {
            $invalid_properties[] = "'answer_text' can't be null";
        }
