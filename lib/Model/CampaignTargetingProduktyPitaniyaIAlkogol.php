...
class CampaignTargetingProduktyPitaniyaIAlkogol implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['pokupka_produktov_pitaniya'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'pokupka_produktov_pitaniya', must be one of #{allowed_values}.";
        }
        ...
        if (!in_array($this->container['pokupka_alkogolya'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'pokupka_alkogolya', must be one of #{allowed_values}.";
        }
