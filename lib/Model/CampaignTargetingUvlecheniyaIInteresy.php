...
class CampaignTargetingUvlecheniyaIInteresy implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['nalichie_hobbi'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'nalichie_hobbi', must be one of #{allowed_values}.";
        }
        ...
        if (!in_array($this->container['uvlecheniya'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'uvlecheniya', must be one of #{allowed_values}.";
        }
