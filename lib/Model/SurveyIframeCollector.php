...
/**
 * SurveyIframeCollector Class Doc Comment
 *
 * @category    Class */
 // @description Способ распространения опроса \&quot;вставка на сайт\&quot;
/** 
 * @package     AnketologClient
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
...
class SurveyIframeCollector extends SurveyCollector implements ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SurveyIframeCollector';
    ...
    {
        return $this->container['iframe_code'];
    }

    /**
     * Sets iframe_code
     * @param string $iframe_code Код для вставки на сайт
     * @return $this
     */
    public function setIframeCode($iframe_code)
    {
        $this->container['iframe_code'] = $iframe_code;
