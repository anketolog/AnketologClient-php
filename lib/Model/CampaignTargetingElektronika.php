...
class CampaignTargetingElektronika implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['elektroniku_priobretali_za_god'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'elektroniku_priobretali_za_god', must be one of #{allowed_values}.";
        }
        ...
        if (!in_array($this->container['byt_tekhniki_priobretali_za_god'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'byt_tekhniki_priobretali_za_god', must be one of #{allowed_values}.";
        }
