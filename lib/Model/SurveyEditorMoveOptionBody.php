...
/**
 * SurveyEditorMoveOptionBody Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     AnketologClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyEditorMoveOptionBody implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SurveyEditorMoveOptionBody';
    ...
    /**
     * Sets option_id
     * @param int $option_id ID варинта/колонки
     * @return $this
     */
