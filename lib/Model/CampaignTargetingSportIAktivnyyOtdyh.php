...
class CampaignTargetingSportIAktivnyyOtdyh implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['vid_sporta'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'vid_sporta', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2");
        if (!in_array($this->container['pokupka_sportivnyh_tovarov'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'pokupka_sportivnyh_tovarov', must be one of #{allowed_values}.";
        }
