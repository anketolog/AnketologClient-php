...
/**
 * SurveyAnswerInfoBody Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     AnketologClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyAnswerInfoBody implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SurveyAnswerInfoBody';
    ...
    /**
     * Sets answer_id
     * @param int $answer_id ID ответа на опрос
     * @return $this
     */
