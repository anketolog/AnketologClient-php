...
class CampaignTargetingPoliticheskayaPrinadlezhnost implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['politicheskaya_aktivnost'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'politicheskaya_aktivnost', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2", "option_3", "option_4", "option_5", "option_6");
        if (!in_array($this->container['politicheskaya_prinadlezhnost'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'politicheskaya_prinadlezhnost', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2", "option_3", "option_4");
        if (!in_array($this->container['chastota_posescheniya_vyborov'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'chastota_posescheniya_vyborov', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1");
        if (!in_array($this->container['sostoit_v_partii'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'sostoit_v_partii', must be one of #{allowed_values}.";
        }
