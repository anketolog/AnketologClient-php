...
class CampaignTargetingPuteshestviya implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['sposob_peredvizheniya'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'sposob_peredvizheniya', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2", "option_3", "option_4", "option_5");
        if (!in_array($this->container['chastota_puteshestviy'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'chastota_puteshestviy', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2", "option_3");
        if (!in_array($this->container['cel_puteshestviy'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'cel_puteshestviy', must be one of #{allowed_values}.";
        }
