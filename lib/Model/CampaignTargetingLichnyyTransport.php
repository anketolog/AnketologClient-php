...
class CampaignTargetingLichnyyTransport implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['nalichie_voditelskih_prav'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'nalichie_voditelskih_prav', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2", "option_3", "option_4", "option_5", "option_6");
        if (!in_array($this->container['kategoriya_prav'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'kategoriya_prav', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2");
        if (!in_array($this->container['nalichie_avtomobilya'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'nalichie_avtomobilya', must be one of #{allowed_values}.";
        }
        ...
        if (!in_array($this->container['marka_avtomobilya'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'marka_avtomobilya', must be one of #{allowed_values}.";
        }
        ...
        if (!in_array($this->container['god_vypuska_from'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'god_vypuska_from', must be one of #{allowed_values}.";
        }

        $allowed_values = array("2017", "2016", "2015", "2014", "2013", "2012", "2011", "2010", "2009", "2008", "2007", "2006", "2005", "2004", "2003", "2002", "2001", "2000", "1999", "1998", "1997", "1996", "1995", "1994", "1993", "1992", "1991", "1990", "1989", "1988", "1987", "1986", "1985", "1984", "1983", "1982", "1981", "1980", "1979", "1978", "1977", "1976", "1975", "1974", "1973", "1972", "1971", "1970", "1969", "1968", "1967", "1966", "1965", "1964", "1963", "1962", "1961", "1960", "1959", "1958", "1957", "1956", "1955", "1954", "1953", "1952", "1951", "1950");
        if (!in_array($this->container['god_vypuska_to'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'god_vypuska_to', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2", "option_3", "option_4", "option_5", "option_6", "option_7");
        if (!in_array($this->container['drugie_transportnye_sredstva'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'drugie_transportnye_sredstva', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1");
        if (!in_array($this->container['uslugi_avtoservisa'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'uslugi_avtoservisa', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2", "option_3", "option_4", "option_5", "option_6", "option_7", "option_8", "option_9", "option_10", "option_11", "option_12", "option_13", "option_14");
        if (!in_array($this->container['avtotovary'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'avtotovary', must be one of #{allowed_values}.";
        }
