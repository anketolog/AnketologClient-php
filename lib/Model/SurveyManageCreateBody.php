...
/**
 * SurveyManageCreateBody Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     AnketologClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyManageCreateBody implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SurveyManageCreateBody';
    ...
    /**
     * Sets template_id
     * @param int $template_id ID шаблона (см. /survey/template/list)
     * @return $this
     */
