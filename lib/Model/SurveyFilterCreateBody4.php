...
/**
 * SurveyFilterCreateBody4 Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     AnketologClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyFilterCreateBody4 implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SurveyFilterCreateBody_4';
    ...
    /**
     * Sets folder_path
     * @param string $folder_path Папка которую необходимо переименовать.  Примеры: * \"Мои анкеты/Подпапка\"  Папка должна существовать.
     * @return $this
     */
