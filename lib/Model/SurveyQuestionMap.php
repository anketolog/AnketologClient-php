...
/**
 * SurveyQuestionMap Class Doc Comment
 *
 * @category    Class */
 // @description Вопрос \&quot;карта\&quot;
/** 
 * @package     AnketologClient
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyQuestionMap extends SurveyQuestion implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SurveyQuestionMap';
    ...
    /**
     * Sets is_limited
     * @param bool $is_limited Ограничение кол-ва точек
     * @return $this
     */
    ...
    public function setKind($kind)
    {
        ...
        if (!in_array($kind, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'kind', must be one of 'default', 'integer', 'float'");
        }
