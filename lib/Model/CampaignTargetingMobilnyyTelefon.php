...
class CampaignTargetingMobilnyyTelefon implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['nalichie_mobilnogo_telefona'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'nalichie_mobilnogo_telefona', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2", "option_3", "option_4", "option_5", "option_6", "option_7", "option_8", "option_9");
        if (!in_array($this->container['operacionnaya_sistema_smartfona'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'operacionnaya_sistema_smartfona', must be one of #{allowed_values}.";
        }
        ...
        if (!in_array($this->container['operator_svyazi'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'operator_svyazi', must be one of #{allowed_values}.";
        }
