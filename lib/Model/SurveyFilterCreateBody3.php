...
/**
 * SurveyFilterCreateBody3 Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     AnketologClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyFilterCreateBody3 implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SurveyFilterCreateBody_3';
    ...
    /**
     * Sets folder_path
     * @param string $folder_path Папка которую необходимо удалить.  Примеры: * \"Мои анкеты/Подпапка\"  Папка должна существовать. В папке не должно быть анкет.
     * @return $this
     */
