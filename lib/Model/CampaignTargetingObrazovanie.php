...
class CampaignTargetingObrazovanie implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['uroven_obrazovaniya'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'uroven_obrazovaniya', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2", "option_3", "option_4", "option_5", "option_6", "option_7", "option_8");
        if (!in_array($this->container['vladenie_inostrannymi_yazykami'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'vladenie_inostrannymi_yazykami', must be one of #{allowed_values}.";
        }
