...
/**
 * SurveyOptionLimit Class Doc Comment
 *
 * @category    Class */
 // @description Ограничение кол-ва выбранных вариантов
/** 
 * @package     AnketologClient
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SurveyOptionLimit implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SurveyOptionLimit';
    ...
    /**
     * Sets min
     * @param int $min Минимум выбранных вариантов
     * @return $this
     */
    ...
    /**
     * Sets max
     * @param int $max Максимум выбранных вариантов
     * @return $this
     */
