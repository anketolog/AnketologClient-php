...
class CampaignTargetingZhilischnyeUsloviya implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['usloviya_prozhivaniya'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'usloviya_prozhivaniya', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1");
        if (!in_array($this->container['vladenie_nedvizhimym_imuschestvom'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'vladenie_nedvizhimym_imuschestvom', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2", "option_3", "option_4", "option_5", "option_6", "option_7", "option_8");
        if (!in_array($this->container['vid_nedvizhimogo_imuschestva_v_sobstvennosti'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'vid_nedvizhimogo_imuschestva_v_sobstvennosti', must be one of #{allowed_values}.";
        }
