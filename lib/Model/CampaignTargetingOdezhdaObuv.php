...
class CampaignTargetingOdezhdaObuv implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['mesta_i_sposoby_priobreteniya_odezhdy'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'mesta_i_sposoby_priobreteniya_odezhdy', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2", "option_3", "option_4", "option_5", "option_6", "option_7", "option_8", "option_9");
        if (!in_array($this->container['pokupka_odezhdy'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'pokupka_odezhdy', must be one of #{allowed_values}.";
        }
