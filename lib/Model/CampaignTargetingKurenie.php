...
class CampaignTargetingKurenie implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['kurilschiki'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'kurilschiki', must be one of #{allowed_values}.";
        }

        $allowed_values = array("option_0", "option_1", "option_2", "option_3", "option_4");
        if (!in_array($this->container['pokupka_tovarov_dlya_kureniya'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'pokupka_tovarov_dlya_kureniya', must be one of #{allowed_values}.";
        }
