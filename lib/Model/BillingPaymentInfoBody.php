...
/**
 * BillingPaymentInfoBody Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     AnketologClient
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BillingPaymentInfoBody implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'BillingPaymentInfoBody';
    ...
    /**
     * Sets payment_id
     * @param int $payment_id ID счета на оплату
     * @return $this
     */
