...
/**
 * CampaignReportApi Class Doc Comment
 *
 * @category Class
 * @package  AnketologClient
 * @author   http://github.com/swagger-api/swagger-codegen
...
class CampaignReportApi
{
    ...
    /**
     * Operation campaignReportAggregate
     *
     * 
     *
     * @param \AnketologClient\Model\CampaignReportAggregateBody $campaign_report_aggregate_body  (required)
     * @return \AnketologClient\Model\SurveyReportAggregate
     * @throws \AnketologClient\ApiException on non-2xx response
     */
    public function campaignReportAggregate($campaign_report_aggregate_body)
    {
        list($response) = $this->campaignReportAggregateWithHttpInfo($campaign_report_aggregate_body);
        return $response;
    }

    /**
     * Operation campaignReportAggregateWithHttpInfo
     *
     * 
     *
     * @param \AnketologClient\Model\CampaignReportAggregateBody $campaign_report_aggregate_body  (required)
     ...
     * @throws \AnketologClient\ApiException on non-2xx response
     */
    public function campaignReportAggregateWithHttpInfo($campaign_report_aggregate_body)
    {
        // verify the required parameter 'campaign_report_aggregate_body' is set
        if ($campaign_report_aggregate_body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $campaign_report_aggregate_body when calling campaignReportAggregate');
        }
        // parse inputs
        $resourcePath = "/campaign/report/aggregate";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        // body params
        $_tempBody = null;
        if (isset($campaign_report_aggregate_body)) {
            $_tempBody = $campaign_report_aggregate_body;
        }
    ...
    /**
     * Operation campaignReportDetail
     *
     * 
     *
     * @param \AnketologClient\Model\CampaignReportDetailBody $campaign_report_detail_body  (required)
     * @return \AnketologClient\Model\SurveyReportDetail
     * @throws \AnketologClient\ApiException on non-2xx response
     */
    public function campaignReportDetail($campaign_report_detail_body)
    {
        list($response) = $this->campaignReportDetailWithHttpInfo($campaign_report_detail_body);
        return $response;
    }

    /**
     * Operation campaignReportDetailWithHttpInfo
     *
     * 
     *
     * @param \AnketologClient\Model\CampaignReportDetailBody $campaign_report_detail_body  (required)
     ...
     * @throws \AnketologClient\ApiException on non-2xx response
     */
    public function campaignReportDetailWithHttpInfo($campaign_report_detail_body)
    {
        // verify the required parameter 'campaign_report_detail_body' is set
        if ($campaign_report_detail_body === null) {
            throw new \InvalidArgumentException('Missing the required parameter $campaign_report_detail_body when calling campaignReportDetail');
        }
        // parse inputs
        $resourcePath = "/campaign/report/detail";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
        ...
        // body params
        $_tempBody = null;
        if (isset($campaign_report_detail_body)) {
            $_tempBody = $campaign_report_detail_body;
        }
