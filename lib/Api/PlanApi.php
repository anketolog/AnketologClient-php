...
class PlanApi
{
     ...
     * 
     *
     * @param \Anketolog\Model\Body23 $body  (required)
     * @return \Anketolog\Model\PlanUserPlan
     ...
     *
     * @param \Anketolog\Model\Body23 $body  (required)
     * @return Array of \Anketolog\Model\PlanUserPlan, HTTP status code, HTTP response headers (array of strings)
     * @throws \Anketolog\ApiException on non-2xx response
     */
    public function planManageChangeWithHttpInfo($body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Anketolog\Model\PlanUserPlan',
                '/plan/manage/change'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Anketolog\Model\PlanUserPlan', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Anketolog\Model\PlanUserPlan', $e->getResponseHeaders());
     ...
     * 
     *
     * @return \Anketolog\Model\PlanPlan[]
     * @throws \Anketolog\ApiException on non-2xx response
     */
     ...
     * 
     *
     * @return Array of \Anketolog\Model\PlanPlan[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Anketolog\ApiException on non-2xx response
     */
    public function planManageListWithHttpInfo()
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Anketolog\Model\PlanPlan[]',
                '/plan/manage/list'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Anketolog\Model\PlanPlan[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Anketolog\Model\PlanPlan[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
