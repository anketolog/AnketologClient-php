...
class BillingApi
{
    ...
    /**
     * Operation billingPaymentCreate
     *
     * 
     *
     * @param \Swagger\Client\Model\Body $body  (required)
     * @return \Swagger\Client\Model\BillingPayment
    ...
    /**
     * Operation billingPaymentCreateWithHttpInfo
     *
     * 
     *
     * @param \Swagger\Client\Model\Body $body  (required)
     * @return Array of \Swagger\Client\Model\BillingPayment, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function billingPaymentCreateWithHttpInfo($body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\BillingPayment',
                '/billing/payment/create'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\BillingPayment', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\BillingPayment', $e->getResponseHeaders());
    ...
    /**
     * Operation billingPaymentInfoWithHttpInfo
     *
     * 
     *
     * @param \Swagger\Client\Model\Body1 $body  (required)
    ...
    {
        list($response) = $this->billingPaymentListWithHttpInfo();
        return $response;
    }

    /**
     * Operation billingPaymentListWithHttpInfo
     *
     * 
     *
     * @return Array of \Swagger\Client\Model\BillingPayment[], HTTP status code, HTTP response headers (array of strings)
    ...
    {
        // parse inputs
        $resourcePath = "/billing/payment/list";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
     ...
     * @return \Swagger\Client\Model\BillingTransfer
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
     ...
     *
     * @param \Swagger\Client\Model\Body2 $body  (required)
     * @return Array of \Swagger\Client\Model\BillingTransfer, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function billingTransferInfoWithHttpInfo($body)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Swagger\Client\Model\BillingTransfer',
                '/billing/transfer/info'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Swagger\Client\Model\BillingTransfer', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Swagger\Client\Model\BillingTransfer', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
